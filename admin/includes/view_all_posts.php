    ...
    foreach ($_POST['checkBoxArray'] as $postValueId) {
        ...
        switch ($bulk_options) {
            ...
            case 'reset':
                ...
                $update_to_reset = mysqli_query($connection, $query);

                //confirmQuery($update_to_reset);
    ...
    <table class="table table-bordered table-hover">
        ...
        <tbody>
            ...
            ?>
                ...
                //  $cat_id = $row['cat_id'];
                //$cat_title = $row['cat_title']; - ovo sve zamijenjeno s query koji spaja posts i categories
                ...
                //$comment_id = $row['comment_id']; - izbacuje mi warning s ovom linijom, a radi sve i bez nje
                ...
                <form method="post"> <!--its safer to delete via post cause noone from the outside can delete from db -->
